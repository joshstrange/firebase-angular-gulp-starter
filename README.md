# Firebase Angular Gulp Starter
Taken from Firebase's Firebase+Angular+AngularFire example. It was restructured and I added gulp to build the static files to push to Firebase.
